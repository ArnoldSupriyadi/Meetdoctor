    ...
    <main class="min-h-screen">
      ...
      <section class="relative mt-12">
          ...
          <div class="hidden lg:block lg:absolute lg:z-10 lg:top-0 lg:right-0" aria-hidden="true">
            <img src="{{('assets/frontsite/images/hero-image.png')}}" class="bg-cover bg-center object-cover object-center max-h-[580px]"
              alt="Hero Image" />
                ...
                <div class="flex flex-wrap gap-16 mt-8">
                  <div class="flex items-center gap-4">
                    <div class="flex-shrink-0">
                      <img src="{{('/assets/frontsite/images/service.svg')}}" alt="service icon" />
                    </div>
                    <div>
