        ...
        >
          ...
          <div class="mt-12">
            ...
            <form method="POST" action="{{ route('register') }}" class="grid gap-6">
              ...
              <label class="block">
                <input
                  for="name" type="text" type="name" id="name" name="name"
            ...
            {{-- 
              ...
              <label class="block">
                <input
                  for="password" type="password" type="password" id="password" name="password"
                  class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
              ...
              <label class="block">
                <input
                  for="password_confirmation" type="password" type="password" id="password_confirmation" name="password_confirmation"
                  class="block w-full rounded-full py-4 text-[#1E2B4F] font-medium placeholder:text-[#AFAEC3] placeholder:font-normal px-7 border border-[#d4d4d4] focus:outline-none focus:border-[#0D63F3]"
