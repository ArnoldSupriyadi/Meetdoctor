...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <link rel="apple-touch-icon" href="{{ asset('/asset/backsite/app-assets/images/ico/apple-icon-120.png')}}">
        <link rel="shortcut icon" type="image/x-icon" href="{{ asset('/asset/backsite/app-assets/images/ico/favicon.ico')}}">
